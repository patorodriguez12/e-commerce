    ...
    <div className="bg-surface border border-border rounded-xl overflow-hidden">
      ...
      <div className="p-3.5 flex flex-col gap-2">
        ...
        <div className="flex justify-between items-center mt-1">
          ...
          <Skeleton style={{ height: "28px", width: "80px", borderRadius: "6px" }} />
        </div>
      </div>
    </div>
  );
    ...
    <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-16 items-start">
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-3">
          <Skeleton style={{ height: "24px", width: "30%", borderRadius: "20px" }} />
        ...
        <div className="flex items-center gap-4 pb-6 border-b border-border">
          ...
          <Skeleton style={{ height: "24px", width: "100px", borderRadius: "20px" }} />
        </div>
        ...
        <div className="flex gap-3">
          ...
          <Skeleton style={{ width: "52px", height: "48px", borderRadius: "8px" }} />
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-[400px] flex flex-col gap-8">
        <div className="text-center">
          <Skeleton style={{ height: "20px", width: "120px", margin: "0 auto" }} />
        </div>
        <div className="text-center">
          <Skeleton style={{ height: "32px", width: "220px", margin: "0 auto" }} />
          <Skeleton style={{ height: "14px", width: "160px", margin: "12px auto 0" }} />
        </div>
        <div className="bg-surface border border-border rounded-xl p-6 flex flex-col gap-5">
          ...
          <div className="text-center">
            <Skeleton style={{ height: "13px", width: "100px", margin: "0 auto" }} />
          </div>
        ...
        <div className="text-center">
          <Skeleton style={{ height: "13px", width: "140px", margin: "0 auto" }} />
        </div>
      </div>
    </div>
  );
    ...
    <div className="max-w-[560px] mx-auto px-6 py-12 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4">
        {Array.from({ length: 3 }).map((_, i) => (
          ...
          >
            <Skeleton style={{ width: "64px", height: "64px", borderRadius: "8px", flexShrink: 0 }} />
      ...
      <div className="bg-surface border border-border rounded-xl p-4 flex flex-col gap-2.5">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex items-center gap-2">
            <Skeleton style={{ width: "16px", height: "16px", borderRadius: "50%" }} />
    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex gap-3 mt-2">
          <Skeleton style={{ height: "44px", width: "140px", borderRadius: "8px" }} />
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <Skeleton style={{ height: "24px", width: "70px", borderRadius: "20px" }} />
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        {Array.from({ length: 3 }).map((_, i) => (
          ...
          >
            <Skeleton style={{ width: "80px", height: "80px", borderRadius: "8px", flexShrink: 0 }} />
            <div className="flex-1 flex flex-col gap-1.5">
          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              ...
              <div className="flex gap-2 mt-1">
                <Skeleton style={{ height: "28px", width: "80px", borderRadius: "6px" }} />
                <Skeleton style={{ height: "28px", width: "60px", borderRadius: "6px" }} />
              </div>
            </div>
          </div>
        ))}
